locals {
  dev_mode = "none" # "vultr", "none"

  # derived locals
  dev_ipv4       = local.dev_mode == "vultr" ? vultr_instance.dev[0].main_ip : null
  dev_ipv6       = local.dev_mode == "vultr" ? vultr_instance.dev[0].v6_main_ip : null
  instance_id    = local.dev_mode == "vultr" ? vultr_instance.dev[0].id : null
